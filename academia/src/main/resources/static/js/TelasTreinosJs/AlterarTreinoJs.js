$(document).ready(function () {
    ...
    // Verificar se showDivAlterar é "false" ou "true"
    var showDivAlterar = $('#showDivAlterar').val();
    if (showDivAlterar === "true") {
        $('#divAlterar').removeClass("esconder");
        $('#form-pesquisa-treino').addClass("esconder");
    } else {
        $('#divAlterar').addClass("esconder");
         $('#form-pesquisa-treino').removeClass("esconder");
    }
